...
describe('Room Router', () => {
    describe('POST /api/v1/rooms', () => {
        it('should create a new room', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const { createRoom } = yield Promise.resolve().then(() => __importStar(require('../src/controllers/room.controller.ts')));
            yield createRoom(req, res);
    ...
    describe('GET /api/v1/rooms', () => {
        it('should get all rooms', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const { getAllRooms } = yield Promise.resolve().then(() => __importStar(require('../src/services/index.service.ts')));
            yield getAllRooms(req, res);
            expect(res.status.calledWith(200)).to.be.true;
            expect(res.json.calledWith(sinon_1.default.match({ data: sinon_1.default.match.array }))).to.be.true;
        }));
    });
});
//# sourceMappingURL=roomRouter.test.js.map